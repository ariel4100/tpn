...
@section('content')
    <div class="container p-4">
        ...
        <form class="row" method="POST" action="{{ route('metadatos.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <div class="md-form">
                ...
                <div class="col-md-6">
                    <div class="md-form">
                        <textarea id="keyword" class="md-textarea form-control" name="keyword" rows="3"></textarea>
                ...
                <div class="col-md-6">
                    <div class="md-form">
                        <textarea id="Descripcion" class="md-textarea form-control" name="descripcion" rows="3"></textarea>
